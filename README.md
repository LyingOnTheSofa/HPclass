...
然后在控制台输入
 	...
 	taskmgr
打开任务管理器，点击”运行“，在”运行“中点击”浏览“就可以在文件路径打开任意文件啦，可以联网游戏哦。
...
2、还原后无需再次运行，直接从ctrl-alt-delete那一步开始就行了

3、在“切换用户”界面或该界面下的其他窗口中，若长时间无操作输入（鼠标点击、按键），会自动退回到控屏界面，请知悉

4、对于焚决，我想你们应该知道该采取怎样的态度awa，不要让大家都用不了哦
